...
LDLIBSOPTIONS=lib/Linux.gnu.Debug_32/libBeaEngine_s_d.a -lm
...
${OBJECTDIR}/instruction.o: instruction.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/instruction.o instruction.c
...
${OBJECTDIR}/loaderElf.o: loaderElf.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/loaderElf.o loaderElf.c
...
${OBJECTDIR}/desassembleur.o: desassembleur.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/desassembleur.o desassembleur.c
...
${OBJECTDIR}/Fichier.o: Fichier.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Fichier.o Fichier.c

${OBJECTDIR}/liste_instr.o: liste_instr.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/liste_instr.o liste_instr.c

${OBJECTDIR}/commandes.o: commandes.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/commandes.o commandes.c
...
${OBJECTDIR}/registre.o: registre.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/registre.o registre.c

${OBJECTDIR}/memoire.o: memoire.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/memoire.o memoire.c

${OBJECTDIR}/variable.o: variable.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/variable.o variable.c

${OBJECTDIR}/Vide.o: Vide.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Vide.o Vide.c
