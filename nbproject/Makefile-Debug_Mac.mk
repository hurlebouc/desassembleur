...
${OBJECTDIR}/instruction.o: instruction.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I/opt/local/include/libelf -MMD -MP -MF $@.d -o ${OBJECTDIR}/instruction.o instruction.c
...
${OBJECTDIR}/liste_instr.o: liste_instr.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I/opt/local/include/libelf -MMD -MP -MF $@.d -o ${OBJECTDIR}/liste_instr.o liste_instr.c
