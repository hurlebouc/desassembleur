...
typedef struct _Disasm {
   ...
   /*
    * Donne l adresse suposee du point de depart
    * Toutes les adresses des branches seront calculees
    * a partir de cette adresse virtuelle.
    * 
    * En effet, il faut savoir que (normalement) les adresses dans le programme
    * sont relative a la position courante de l intruction.
    * 
    */
